...
unless Rails.env.test?
  ...
  Rails.application.config.content_security_policy do |policy|
    ...
    policy.img_src     :self, :data, :blob, 'cloudinary.com', 'openstreetmap.org', 'stats.data.gouv.fr', 'crisp.chat', 'crisp.chat', 'https://image.crisp.chat/'
    ...
    if Rails.env.development?
      policy.script_src  :self, 'script_dynamic', 'http://localhost:3000', 'stats.data.gouv.fr', 'mapbox.com', 'crisp.chat', 'client.crisp.chat', 'https://stats.data.gouv.fr/piwik.js', 'https://settings.crisp.chat'
      ...
      policy.script_src  :self, 'stats.data.gouv.fr', 'crisp.chat', 'crisp.chat', 'mapbox.com', 'https://client.crisp.chat/l.js', 'https://settings.crisp.chat', 'https://stats.data.gouv.fr/piwik.js', 'https://client.crisp.chat/static/javascripts/client.js'
