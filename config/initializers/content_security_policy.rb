...
unless Rails.env.test?
  ...
  Rails.application.config.content_security_policy do |policy|
    ...
    if Rails.env.development?
      policy.script_src  :self, 'http://localhost:3000', 'stats.data.gouv.fr', '*.mapbox.com', '*.crisp.chat:*', '*.client.crisp.chat:*', 'https://stats.data.gouv.fr/piwik.js', 'https://www.recaptcha.net/recaptcha/api.js', 'https://www.gstatic.com/recaptcha/releases/4lbq4vBYAu25DMtzZ7GGbfAF/recaptcha__en.js'
      ...
      policy.script_src  :self, 'stats.data.gouv.fr', '*.crisp.chat', 'crisp.chat', '*.mapbox.com', 'https://client.crisp.chat/l.js', 'https://stats.data.gouv.fr/piwik.js', 'https://client.crisp.chat/static/javascripts/client.js', 'https://www.recaptcha.net/recaptcha/api.js', 'https://www.gstatic.com/recaptcha/releases/4lbq4vBYAu25DMtzZ7GGbfAF/recaptcha__en.js'
